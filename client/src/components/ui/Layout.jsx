...
const Layout = ({ children }) => {
	...
	return (
		<div className="min-h-screen bg-muted">
			<header className="bg-background shadow-sm max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
				<nav className="flex justify-between items-center h-16">
					...
					<div className="flex items-center gap-1">
						...
						>
							{isLoggingOut ? <Loader2 className="size-4 animate-spin text-blue-600" /> : <LogOut className="size-4" />}
							Logout
						</button>
					</div>
				</nav>
