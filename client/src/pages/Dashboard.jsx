						...
						<div className="flex-1">
							<div className="relative">
								...
								<input
									...
									className="w-full pl-10 pr-4 py-2 border border-primary/20 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none placeholder:text-primary/40"
								/>
							</div>
						</div>
